...
if ($_SERVER['REQUEST_METHOD'] == "GET" && !empty($_GET['id'])) {
    ...
    $image_profile = $activity_detail['image_profile'];

    $images = explode(',', $activity_detail['image']);
    $title = $activity_detail['title'];
    $content = $activity_detail['content'];
    $created_at = date('d-m-Y', strtotime($activity_detail['created_at']));
} else {
