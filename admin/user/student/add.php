...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $student->createStudentByAdmin($student_code, $first_name, $last_name, $password, $email, $phone, $education_level, $image);
...
<body>
    ...
    <div class="main-content">
        <form id="createForm" enctype="multipart/form-data">
            <div class="card-body">
                <h3 class="h3 mb-4 text-success">สร้างบัญชี นักเรียน/นักศึกษา ใหม่</h3>
                <div class="row">
                    <div class="col-md-2">
