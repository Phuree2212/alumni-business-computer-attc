...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $student->createAlumniByAdmin($student_code, $first_name, $last_name, $password, $email, $phone, $education_level, $graduation_year, $image);
...
<body>
    ...
    <div class="main-content">
        <form id="createForm" enctype="multipart/form-data">
            <div class="card-body">
                <h3 class="h3 mb-4 text-success">สร้างบัญชี ศิษย์เก่า</h3>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="studentCode" name="student_code">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="graduationYear" name="graduation_year" placeholder="ปี พ.ศ. ที่จบการศึกษา เช่ร 2563">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (!data.education_level || data.education_level === "") {
                showFieldError('education_level', 'กรุณาเลือกระดับชั้น');
                isValid = false;
            }

            if (!validateYear(data.graduation_year)) {
                showFieldError('graduationYear', 'รูปแบบปีจบการศึกษาไม่ถูกต้อง');
                isValid = false;
            }
