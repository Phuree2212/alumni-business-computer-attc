...
<body>
    ...
    <div class="main-content">
        <!-- Heading -->
        <div class="d-flex">
            <h3 class="table-header mb-5"><b>จัดการข้อมูลข่าวสาร/ประชาสัมพันธ์</b></h3>
            <div>
                <a href="add.php" class="btn btn-success mx-3">เพิ่มข่าวสารใหม่</a>
            </div>
        </div>
        ...
        <div class="table-container">
            <div class="table-responsive">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="../../assets/images/news/<?= $first_image ?>" alt="<?= $title ?>">
                                    </td>
                                    <td><?= $created_by ?></td>
                                    <td><?= $created_at ?></td>
                                    <td class="text-center">
                ...
                <?php if (empty($news_list)) { ?>
                    <div class="text-center text-danger">ไม่พบข้อมูลข่าวสาร</div>
                <?php } ?>
